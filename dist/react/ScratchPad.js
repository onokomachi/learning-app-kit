...
function ColumnFrame({ grid, cur, setCur, op }) {
    return (_jsx("div", { style: { overflowX: 'auto' }, children: _jsx("div", { style: { display: 'inline-block', minWidth: 300 }, children: grid.map((row, r) => (_jsxs("div", { style: { display: 'flex', alignItems: 'center', marginBottom: 2 }, children: [_jsx("span", { style: { width: 26, fontSize: 18, fontWeight: 800, color: '#7c8da6', textAlign: 'center' }, children: r === 1 ? op : '' }), _jsx("div", { style: {
                            display: 'flex', gap: 2,
